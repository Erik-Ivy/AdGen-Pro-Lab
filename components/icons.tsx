...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m1-12l1.09 2.18L12 12l-1.09 2.18L9 17l-2.18-1.09L5 12l2.18-1.09L9 7l2.18 1.09L13 12l-1.82 2.18L9 17m9-14l-1.09 2.18L17 7l-2.18 1.09L13 10l1.82 1.09L17 13l2.18-1.09L21 10l-1.82-1.09L17 7z" />
  </svg>
);
...
export const LandingPageIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h12a2 2 0 012 2v8a2 2 0 01-2 2h-2m-6 0l-2-2m2 2l2-2m-2 2v2m0 0a2 2 0 104 0m-4 0a2 2 0 114 0" />
  </svg>
);
...
export const AspectRatioVerticalIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <rect x="7" y="3" width="10" height="18" rx="2" stroke="currentColor" strokeWidth="2" />
  </svg>
);

export const AspectRatioHorizontalIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
